#!/bin/sh
# !DESC-EN!90!release_notes!View Propaganda Streaming Audio System Release Notes
# !DESC-RU!90!release_notes!Виев Пропаганда Стреаминг Аудио Система Нотиь
...
# $Id: release_notes.sh,v 1.1 2009-07-23 08:30:56 brian Exp $
...
### SCRIPT MAIN LOOP ###
dialog --backtitle "Propaganda: Release Notes" \
    --title "Release Notes" --begin 2 2 \
    --msgbox "$(cat ${RELEASE_NOTES})" 21 75
